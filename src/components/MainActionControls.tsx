          ...
          >
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full justify-between gap-6">
                <span className="text-[10px] font-semibold uppercase tracking-widest text-linen-muted">Complete</span>
          ...
          >
            <div
              className={`text-[10px] font-semibold uppercase tracking-widest ${
                statusToday === 'active' ? 'text-linen-muted' : 'text-ink-500'
              }`}
            >
              Today's Status
            </div>
            ...
            <p className={`text-sm font-medium ${statusToday === 'active' ? 'text-linen-muted' : 'text-ink-500'}`}>
